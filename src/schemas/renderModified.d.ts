...
/**
 * An abbreviated version of the full APRenderRep for use by the AP Designer.
 */
export interface APRenderRepAbbreviated {
  /**
   * The rendering engine the game wants to use.
   */
  renderer?: "default" | "stacking-offset" | "stacking-tiles";
  /**
